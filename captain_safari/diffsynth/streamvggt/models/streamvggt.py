...
class StreamVGGT(nn.Module, PyTorchModelHubMixin):
    def __init__(self, img_size=518, patch_size=14, embed_dim=1024, feature_only=False):
    ...
    def export_memory(self, frames, query_points: torch.Tensor = None, past_key_values=None):        
        ...
        for i, frame in enumerate(frames): # 60 frames
        ...
        return all_aggregated_tokens_cat, None
