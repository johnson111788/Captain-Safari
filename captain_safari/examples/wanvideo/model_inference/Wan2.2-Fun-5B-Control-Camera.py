...
input_image = Image.open("data/examples/wan/input_image.jpg").resize((1248, 704))
...
save_video(video, "5b_video_left.mp4", fps=24, quality=5)
...
save_video(video, "5b_video_up.mp4", fps=24, quality=5)